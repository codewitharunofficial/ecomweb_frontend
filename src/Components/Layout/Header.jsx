...
const Header = () => {
  ...
  return (
    <>
      <nav className="navbar navbar-expand-lg navbar-light bg-light" style={{ background: 'linear-gradient(10deg, rgba(0,212,255,1) 0%, rgba(223,219,18,1) 69%)', position: 'fixed', top: 0, width: '100%', zIndex: 1000}}>
