...
const HomePage = () => {
  ...
  return (
    <Layout title="Shopease - HomePage - Best Offers">
          ...
          <div className="carousel-inner">
            <div className="carousel-item active m-3">
              <img
                ...
                src="https://w7.pngwing.com/pngs/561/897/png-transparent-sony-smartwatch-3-apple-watch-android-watch-electronics-gadget-watch-accessory-thumbnail.png"
                height={"300px"}
                alt="First slide"
              />
            </div>
            <div className="carousel-item">
              <img
                className="d-block w-100"
                src="https://mir-s3-cdn-cf.behance.net/projects/404/e6181e120041777.Y3JvcCw5OTksNzgyLDAsMTA4.png"
                height={"300px"}
                alt="Second slide"
              />
            </div>
            <div className="carousel-item">
              <img
                className="d-block w-100"
                src="https://mir-s3-cdn-cf.behance.net/projects/404/198196113332619.Y3JvcCw5OTksNzgyLDAsMTA4.png"
                height={"300px"}
                alt="Third slide"
              />
            </div>
      ...
      <hr
        className="mr-3"
        style={{ borderColor: "#000", borderWidth: "2px", width: "100%" }}
      />
      <div
        className="wrapper p-10"
        style={{
          maxWidth: "100%",
          alignSelf: "center",
          overflow: "hidden",
        ...
        <div className="row mt-3">
          <div className="col-md-2">
            ...
            <div className="d-flex flex-column flex-md-row">
              <button
                className="btn btn-danger p-1 mt-2 ml-4 w-50"
          ...
          <div className="col-md-8 Home ">
            <div
              className="d-flex flex-wrap gap-20"
